...
Output: Updated shifts.py module that loads factors from bundled JSON, configured build system to include data files, cleaned pyproject.toml without ISiCLE.
</objective>
...
5. Tests pass: `pytest tests/ -q` (if any shifts.py tests exist, they may need updating)
</verification>
