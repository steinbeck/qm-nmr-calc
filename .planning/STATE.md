...
- Rolling average of last 10 calculations for ETA (not overall average)
...
- Phase 11.2 inserted after Phase 11.1: Vacuum Benchmark Calculations - run DELTA50 without solvent for gas-phase scaling factors (user request)
